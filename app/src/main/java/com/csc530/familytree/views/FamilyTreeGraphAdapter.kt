...
class FamilyTreeGraphAdapter() : AbstractGraphAdapter<FamilyTreeGraphAdapter.NodeViewHolder>()
{
	...
	{
		val portrait: ImageView = itemView.findViewById<ImageView>(R.id.imgNodePortrait)
		val name: TextView = itemView.findViewById<TextView>(R.id.txtNodeName)
	}
...
//			itemView.setOnClickListener { }
	...
	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NodeViewHolder
	{
		...
		val view = inflater.inflate(R.layout.node_family_memeber, parent, false)
